...
const TableRow = ({ lang, nativeItem }) => {
    ...
    return (
        ...
        >
            <td title={item.media_key} className="text-start p-[0.85rem]">
                <p className="w-full whitespace-nowrap overflow-hidden text-ellipsis">{item.media_key}</p>
            </td>
            <td title={item.type} className="text-start p-[0.85rem]">
                <p className="w-full whitespace-nowrap overflow-hidden text-ellipsis">{item.type}</p>
            </td>
            <td title={item.path} className="text-start p-[0.85rem]">
                <p className="w-full whitespace-nowrap overflow-hidden text-ellipsis">{item.path}</p>
            </td>
            <td title={item.alt[lang]} className="text-start p-[0.85rem]">
                <p className="w-full whitespace-nowrap overflow-hidden text-ellipsis">{item.alt[lang]}</p>
            </td>
