...
const AddForm = () => {
    ...
    const handleChangeJob = useCallback(
        (event) => {
            setJobValue(event.currentTarget.value);
            event.currentTarget.setCustomValidity("");
        },
        [jobValue],
    );
        ...
        <>
            {
                ...
                <div className="fixed top-0 left-0 w-full h-dvh  z-[3000] overflow-hidden" role="dialog">
                    ...
                    <div className="w-full h-full overflow-y-auto relative flex items-baseline justify-center py-5">
                        ...
                        <div className=" w-[90%] sm:w-[80%] overflow-hidden md:w-[60%]">
                            <div className="relative overflow-hidden z-10 grid grid-cols-1 shadow-[var(--bs-box-shadow)] text-[#5d7186] bg-white rounded-xl">
                                ...
                                ">
                                    ...
                                    <h4 className="text-base text-white font-semibold font-secondary ">Add New</h4>
